                ...
                <table class="order_items" border="1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>৳ {{number_format($details->total_price, 2)}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="order_info">
                ...
                <div class="order_details">
                    <table border="0" style="width: 100%; margin-top: 12px;">
                        ...
                        <tr>
                            <th>VAT/TAX : </th>
                            <td> ৳ {{number_format($order->vat+$order->tax, 2)}}</td>
                        </tr>
                        <tr>
                    ...
                    <h5 style="text-align: center; font-size: 22px;">Total Order Amount : ৳ {{number_format($order->total, 2)}}</h5>
                </div>
            </div>
