                ...
                <div class="card-body">
                    <div class="product-category-inner">
                        ...
                        <div class="data-form hidden" id="dataForm">
                            <form class="needs-validation" method="POST" action="{{ url('save/new/menu') }}"
                                enctype="multipart/form-data">
                                @csrf
                                <h3 id="formTitle">New Menu</h3>
                                <div class="form-group">
                                    <label>Menu Name</label>
                                    <input type="text" id="nameInput" name="menu_name" placeholder="Menu Name"
                                        required />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="web_url" id="permalinkInput" placeholder="Web Url"
                                    ...
                                    <small class="form-hint mt-n2 text-truncate">
                                        ...
                                        <a id="permalinkPreview" {{-- href="{{ config('app.url') }}/category/your-slug" --}}
                                            ...
                                            {{ env('APP_FRONTEND_URL') }}/your-slug
                                        </a>
                                    </small>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="app_url" id="permalinkInput1" placeholder="App Url"
                                        oninput="updateSlugPreview()" />

                                    <small class="form-hint mt-n2 text-truncate">
                                        Preview url:
                                        <a id="permalinkPreview1" {{-- href="{{ config('app.url') }}/category/your-slug"
                                        --}}
                                            style="color:darkcyan;font-size: 12px" target="_blank">
                                            {{ env('APP_FRONTEND_URL') }}/your-slug
                                        </a>
                                ...
                                <input type="hidden" name="slug" id="permalinkInput2" placeholder="Slug" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control w-100" data-toggle="select2" id="parentInput"
                                        ...
                                        @foreach (\App\Models\Menu::getTree(0) as $option)
                                            {!! $option !!}
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="number" id="sortInput" class="form-control" name="sort"
...
@section('footer_js')
    ...
    <script>
        ...
        $('body').on('click', '.deleteBtn', function() {
            var menuSlug = $(this).data("id");
            if (confirm("Are You sure want to delete !")) {
                $.ajax({
                    type: "GET",
                    url: "{{ url('/delete/menu') }}" + '/' + menuSlug,
                    success: function(data) {
                        table.draw(false);
                        toastr.error("Menu has been Deleted", "Deleted Successfully");
                    },
                    error: function(data) {
    ...
    <script type="text/javascript">
        ...
        const permalinkInput1 = document.getElementById("permalinkInput1");
            ...
            if (e.target.classList.contains("delete-btn")) {
                ...
                if (li) {
                    ...
                    if (
                        ...
                        $.ajax({
                            type: "GET",
                            url: "{{ url('/delete/menu') }}" + '/' + li.dataset.slug,
                            success: function(data) {
                                table.draw(false);
                                toastr.error("Menu has been Deleted", "Deleted Successfully");
                            },
    ...
    <script>
        function updateSlugPreview() {
            ...
            previewLink.href = `{{ config('app.url') }}/product-menus/${slug}`;
            previewLink.textContent = `{{ config('app.url') }}/product-menus/${slug}`;
            previewLink1.href = `{{ config('app.url') }}/product-menus/${slug}`;
            previewLink1.textContent = `{{ config('app.url') }}/product-menus/${slug}`;
        }
    </script>
@endsection
