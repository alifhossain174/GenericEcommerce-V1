                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="banner_bg">Banner Background Image <span
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="section_title" name="section_title" class="form-control"
                                        placeholder="Write Section Title Here" value="{{ $data->section_title }}" required>
                                    <div class="invalid-feedback" style="display: block;">
                                        @error('section_title')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="btn_icon_class" value="{{ $data->btn_icon_class }}"
                                                name="btn_icon_class" class="form-control" placeholder="fi-rs-download">
                                            <div class="invalid-feedback" style="display: block;">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="mission_image" class="dropify" data-height="203"
                                        data-max-file-size="1M" accept="image/*" />
                                </div>

                                <div class="form-group">
                                    <label for="mission_btn_text">Mission Button Text</label>
                                    <input type="text" id="mission_btn_text" value="{{ $data->mission_btn_text }}"
                                        name="mission_btn_text" class="form-control" placeholder="Enter Text Here">
                                    <div class="invalid-feedback" style="display: block;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mission_btn_link" value="{{ $data->mission_btn_link }}"
                                        name="mission_btn_link" class="form-control" placeholder="https://">
                                    <div class="invalid-feedback" style="display: block;">
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <label for="mission_section_title">Mission Section Title <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="mission_section_title"
                                        value="{{ $data->mission_section_title }}" name="mission_section_title"
                                        class="form-control" placeholder="Our  Mission">
                                    <div class="invalid-feedback" style="display: block;">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="vision_image" class="dropify" data-height="203"
                                        data-max-file-size="1M" accept="image/*" />
                                </div>

                                <div class="form-group">
                                    <label for="vision_btn_text">Vision Button Text</label>
                                    <input type="text" id="vision_btn_text" value="{{ $data->vision_btn_text }}"
                                        name="vision_btn_text" class="form-control" placeholder="Enter Text Here">
                                    <div class="invalid-feedback" style="display: block;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="vision_btn_link" value="{{ $data->vision_btn_link }}"
                                        name="vision_btn_link" class="form-control" placeholder="https://">
                                    <div class="invalid-feedback" style="display: block;">
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <label for="vision_section_title">Vision Section Title <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="vision_section_title"
                                        value="{{ $data->vision_section_title }}" name="vision_section_title"
