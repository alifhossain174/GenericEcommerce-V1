                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="file" name="image_for_app" class="dropify" data-height="200"
                                    data-max-file-size="1M" accept="image/*" />
                                <small class="form-text text-muted">[ Please upload jpg, jpeg, png file of 500px * 260px
                                    ]</small>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="link_for_app" class="form-control" id="link_for_app"
                                            placeholder="https://">
                                        <div class="invalid-feedback" style="display: block;">
                                            @error('link_for_app')
                                            {{ $message }}
