                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{url('update/banner')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="slider" class="col-sm-2 col-form-label">Banner</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="position" class="col-sm-2 col-form-label">Position <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
