                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="position" id="position" required>
                                ...
                                <option value="top" @if($data->position == 'top') selected @endif>Top
                                    (Homepage)</option>
                                <option value="left" @if($data->position == 'left') selected @endif>Left
                                    (Homepage)</option>
                                <option value="right" @if($data->position == 'right') selected @endif>Right
                                    (Homepage)</option>
                                <option value="middle" @if($data->position == 'middle') selected
                                    @endif>Middle (Homepage)</option>
                                <option value="bottom" @if($data->position == 'bottom') selected
                                    @endif>Bottom (Homepage)</option>
                                <option value="shop" @if($data->position == 'shop') selected @endif>Top
                                    (ShopPage)</option>
                                <option value="popup" @if($data->position == 'popup') selected @endif>Popup
                                    (Homepage)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="link_for_app" value="{{$data->link_for_app}}" class="form-control"
                                id="link_for_app" placeholder="https://">
                            <div class="invalid-feedback" style="display: block;">
                                @error('link_for_app')
                                {{ $message }}
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10 pl-0">
                                    <input type="text" name="sub_title" value="{{$data->sub_title}}" id="sub_title"
                                        class="form-control" placeholder="Write Sub Title Here" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 pl-0">
                                    <input type="text" name="btn_text" id="btn_text" value="{{$data->btn_text}}"
                                        class="form-control" placeholder="ex. New Collection" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="btn_link" value="{{$data->btn_link}}" class="form-control"
                                id="btn_link" placeholder="https://">
                        </div>
                    </div>
                </div>
