                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5" name="store_description" id="store_description" placeholder="Store Description">{{$store->store_description}}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="store_full_description" class="col-form-label">Description</label>
                                    <textarea class="form-control" name="store_full_description" id="store_full_description">{!! $store->store_full_description !!}</textarea>
                                </div>
